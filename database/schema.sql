...
--
-- Host: localhost    Database: nega_sell_pc
-- ------------------------------------------------------
...
CREATE TABLE `chat_history` (
  ...
  `chatted_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `chat_history_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)
...
CREATE TABLE `customers` (
  ...
  `gender` varchar(20) DEFAULT 'Kh?c',
  PRIMARY KEY (`id`),
...
CREATE TABLE `orders` (
  ...
  `shipping_fee` decimal(15,2) NOT NULL DEFAULT 50000.00,
...
CREATE TABLE `product_variant_options` (
  ...
  CONSTRAINT `product_variant_options_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `provinces_shipping`
--

DROP TABLE IF EXISTS `provinces_shipping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `provinces_shipping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `province_name` varchar(100) NOT NULL,
  `shipping_fee` decimal(15,2) NOT NULL DEFAULT 30000.00,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
...
CREATE TABLE `support_sessions` (
  ...
  CONSTRAINT `support_sessions_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `support_sessions_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
CREATE TABLE `vouchers` (
  ...
  `is_freeship` tinyint(1) DEFAULT 0,
...
-- Dump completed on 2026-06-05 13:18:26
