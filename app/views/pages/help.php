...
<div class="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8 mt-6">
    ...
    <div class="text-center max-w-2xl mx-auto mb-16">
        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-primary/10 text-primary font-bold text-xs uppercase tracking-wider mb-4">
            ...
            <?php echo __('help_title_tag', 'Hỗ Trợ Khách Hàng'); ?>
        </span>
        <h1 class="text-4xl md:text-5xl font-black text-primary mb-4 tracking-tight leading-none"><?php echo __('help_title', 'Trung Tâm Trợ Giúp'); ?></h1>
        <p class="text-on-surface-variant text-base"><?php echo __('help_subtitle', 'Tìm kiếm câu trả lời nhanh cho các câu hỏi thường gặp về dịch vụ và mua sắm tại TechExpert.'); ?></p>
    </div>
    ...
    <div class="space-y-12">
        ...
        <div>
            <h2 class="text-xl font-black text-primary mb-6 flex items-center gap-2 pb-2 border-b border-outline-variant/30">
                ...
                <?php echo __('help_cat_1', 'Mua Hàng & Thanh Toán'); ?>
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(1)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q1', 'Làm cách nào để tôi đặt hàng trực tuyến?'); ?></span>
                    ...
                    <div id="faq-content-1" class="hidden px-6 pb-6 text-on-surface-variant text-sm leading-relaxed border-t border-outline-variant/10 pt-4 bg-[#F8F9FB]/50">
                        <?php echo __('help_a1', 'Quy trình mua hàng trực tuyến gồm 4 bước cực kỳ đơn giản:<br>1. **Tìm kiếm sản phẩm:** Duyệt qua các danh mục hoặc sử dụng thanh tìm kiếm để tìm sản phẩm mong muốn.<br>2. **Chọn cấu hình (nếu có):** Đối với các sản phẩm có phiên bản (RAM, SSD, màu sắc), bạn vui lòng chọn tùy chọn cấu hình yêu thích của mình.<br>3. **Thêm vào giỏ hàng:** Nhấn "Thêm vào giỏ hàng" hoặc "Mua ngay" để chuyển đến trang giỏ hàng.<br>4. **Thanh toán:** Nhập thông tin giao hàng, chọn phương thức thanh toán (COD hoặc chuyển khoản qua mã VietQR) và hoàn tất đặt hàng.'); ?>
                    </div>
                </div>
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(2)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q2', 'TechExpert hỗ trợ những phương thức thanh toán nào?'); ?></span>
                    ...
                    <div id="faq-content-2" class="hidden px-6 pb-6 text-on-surface-variant text-sm leading-relaxed border-t border-outline-variant/10 pt-4 bg-[#F8F9FB]/50">
                        <?php echo __('help_a2', 'Chúng tôi hỗ trợ các phương thức thanh toán linh hoạt sau:<br>- **Thanh toán tiền mặt khi nhận hàng (COD):** Bạn kiểm tra sản phẩm trước khi thanh toán cho nhân viên giao hàng.<br>- **Chuyển khoản Ngân hàng qua VietQR (Tự động):** Hệ thống sẽ tạo mã QR động chứa sẵn số tiền và nội dung chuyển khoản. Khi bạn thanh toán thành công, đơn hàng sẽ lập tức chuyển sang trạng thái "Đã thanh toán" một cách tự động.'); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div>
            <h2 class="text-xl font-black text-primary mb-6 flex items-center gap-2 pb-2 border-b border-outline-variant/30">
                ...
                <?php echo __('help_cat_2', 'Tư Vấn Lắp Đặt & Chatbot AI'); ?>
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(3)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q3', 'Làm sao để tôi sử dụng AI hỗ trợ tự dựng cấu hình PC?'); ?></span>
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(4)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q4', 'Các linh kiện trong bộ PC có được đảm bảo tương thích không?'); ?></span>
        ...
        <div>
            <h2 class="text-xl font-black text-primary mb-6 flex items-center gap-2 pb-2 border-b border-outline-variant/30">
                ...
                <?php echo __('help_cat_3', 'Tài Khoản & Khuyến Mãi'); ?>
            </h2>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(5)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q5', 'Tôi có được giảm giá khi mua hàng lần đầu không?'); ?></span>
                    ...
                    <div id="faq-content-5" class="hidden px-6 pb-6 text-on-surface-variant text-sm leading-relaxed border-t border-outline-variant/10 pt-4 bg-[#F8F9FB]/50">
                        <?php echo __('help_a5', 'Có. Mọi khách hàng mới khi đăng ký tài khoản tại hệ thống đều có thể thu thập các mã giảm giá (voucher) độc quyền ngay trên trang chủ. Bạn chỉ cần bấm "Lưu vào ví", các mã này sẽ xuất hiện tại phần "Khuyến mãi của tôi" trong hồ sơ cá nhân và tự động gợi ý áp dụng khi bạn thực hiện thanh toán.'); ?>
                    </div>
                </div>
                ...
                <div class="bg-surface-container-lowest rounded-2xl border border-outline-variant/30 overflow-hidden">
                    <button onclick="toggleFaq(6)" class="w-full px-6 py-5 flex items-center justify-between text-left font-bold text-primary hover:bg-surface-container-low transition-colors duration-200 focus:outline-none">
                        <span><?php echo __('help_q6', 'Tại sao tôi không nhận được mã xác thực kích hoạt tài khoản?'); ?></span>
