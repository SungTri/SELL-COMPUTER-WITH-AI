...
<main class="flex-1 w-full flex flex-col h-screen overflow-y-auto bg-[#F8F9FB]">
    ...
    <header class="h-20 bg-white border-b border-outline-variant flex items-center justify-between px-10 sticky top-0 z-10">
        ...
        <div class="flex items-center gap-6">
            <form method="GET" action="<?php echo URLROOT; ?>/admin/feedbacks" class="relative w-96">
                <span class="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-on-surface-variant">search</span>
                <input name="search" value="<?php echo $data['search']; ?>" class="w-full pl-12 pr-4 py-2.5 bg-[#F3F4F6] rounded-full border-none text-body-md focus:ring-2 focus:ring-secondary/20 transition-all" placeholder="Tìm tên, email, tiêu đề góp ý..." type="text"/>
            </form>
